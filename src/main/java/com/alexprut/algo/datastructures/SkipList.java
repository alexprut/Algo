 ...
 * average complexity for search as well as O(log n) average complexity for insertion within
 * an ordered sequence of n elements.
 * Thus, it can get the best features of a sorted array (for searching) while maintaining a linked
 * list-like structure that allows insertion, which is not possible with a static array.
 *
 * <p>Example:
 *
 * <pre>
...
public class SkipList<T extends Comparable<T>> {
    ...
    /**
     * Return the level where the new element should be added.
     * Randomized coin flips function.
     *
     * <p>Time complexity: Θ(1)
     *
     * <p>Space complexity: Θ(1)
