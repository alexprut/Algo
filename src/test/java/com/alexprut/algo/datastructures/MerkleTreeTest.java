...
public class MerkleTreeTest {
  ...
  public void shouldGetRoot() {
    Assertions.assertEquals(
        "ffb45343c6dbeb8491483ffa9020420e029909b263480ea37b21e3cad75b11f2", tree.root());
  }
  ...
  public void shouldVerifyPath() {
    ...
    Assertions.assertFalse(MerkleTree.verify(elements.get(1), tree.root(), tree.getProofPath(0)));
  }
  ...
  public void shouldGetProofPath() {
    ...
    Assertions.assertEquals(expectedPath0, tree.getProofPath(0));
    Assertions.assertEquals(expectedPath3, tree.getProofPath(3));
  }
